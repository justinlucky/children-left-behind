...
// const images = importImages(require.context("../../../images/HudhudCycloneRelief", false, /\.(png|jpe?g|svg)$/));
...
//       {/* <h2 className="gallery-title">Hudhud Cyclone Relief Gallery</h2> */}
...
// <h2>CARDS Team distributing Vegitables and Vessels, Water Packets, Provisions to Hudhhudh Cyclone effected Families</h2>
//  <div className="gallery-grid">
// {secondGroup.map((img, index) => (
//     <img 
//     key={index + 4}
//     src={img}
//     alt={`CARDS team distribution image ${index + 5}`}
//     className="gallery-img"
//     />
