        ...
        <>
            ...
            <section className="content-section">
                <div className="container">
                    <h2 style={{ textAlign: 'center' }} className="title">Pavani Special School</h2>
                    ...
                    <div className="p-6 space-y-6 leading-relaxed text-gray-800">
                        ...
                        <div>
                            <p className="text-xl font-bold mb-2">
                                Pavani’s Aims and Objectives:
                            </p>
                            <p>
                                To empower mentally challenged children with life skill education.<br></br>
                                To impart vocational education and enhance livelihood skills through job oriented courses.<br></br>
                                To ensure placements and self-employment avenues through advocacy and networking with government departments, corporate, NGOs and philanthropists.<br></br>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>Our sincere thanks to Knoah Solutions, Hyderabad for donating four desk top systems for the school.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                In order to acquaint and familiarize the special kids with money management in their everyday lives the school has set up a consumer store. Children are encouraged to purchase stationary and snacks to understand the process of money exchange. The consumer store is managed by the special students themselves.
                            </p>
                        </div>
